  ...
  <div class="shop-header">
    ...
    <div class="shop-content">
      ...
      <div class="header-content">
        <h2 @click="isShowNotice = true" class="content-title">
    ...
    <div class="shop-header-discounts">
      <div @click="isShowdiscount = true" class="discounts-left">
    ...
    <div class="shop-brief-modal" v-show="isShowNotice">
      <div class="brief-modal-content">
        ...
        <div class="mask-footer">
          <span class="iconfont icon-close" @click="isShowNotice = false"></span>
        </div>
      </div>
